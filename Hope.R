setwd("G:\\OOF\\Bioinformatics\\Projects\\2nd Congress\\TCGA\\Data")
...
######################################################
# Assuming "GeneName" is the column with gene names in your geneNameToEnsemblIDMap dataframe
duplicate_genes <- geneNameToEnsemblIDMap$GeneName[duplicated(geneNameToEnsemblIDMap$GeneName)]
